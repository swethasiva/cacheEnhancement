...
python Interset_Number_of_writes.py facesim/facesim.txt > 1_Write_Count/Interset_Variations/facesim_prp_Interset.csv
...
python Intraset_Number_of_writes.py facesim/facesim.txt > 1_Write_Count/Intraset_Variations/facesim_prp_Intraset.csv
